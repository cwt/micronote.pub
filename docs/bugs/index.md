...
| --- | --- | --- | --- | --- |
| [BUG-001](./001.md) | String Splitting in IndieAuth Scopes Corrupts Authorization Tokens | High | IndieAuth | Open |
| [BUG-002](./002.md) | Unhandled TypeError and HTTP 500 Crash During WebAuthn Login | High | Admin / Auth | Open |
